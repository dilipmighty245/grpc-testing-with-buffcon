...
// Source: ./proto/greeter/greeter.pb.go
...
import (
	...
	greeter "github.com/dilipmighty/testing-grpc/proto/greeter"
...
func (m *MockGreeterClient) SayHello(ctx context.Context, in *greeter.HelloRequest, opts ...grpc.CallOption) (*greeter.HelloReply, error) {
	m.ctrl.T.Helper()
...
// SayHello mocks base method.
func (m *MockGreeterServer) SayHello(arg0 context.Context, arg1 *greeter.HelloRequest) (*greeter.HelloReply, error) {
	m.ctrl.T.Helper()
